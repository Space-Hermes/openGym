  ...
  test('renders canonical loads in the profile display unit', () => {
    ...
    S.workouts = [{
      ...
      bw: 80, entries: [{
        id: push.ex[0].id,
        target: {
          mode: 'reps', weight: 100, topW: 101, fallbackWeight: 50, resolvedWeight: 40,
          bw: 10, workW: 75, workWeight: 80, workResolvedWeight: 90,
          loadFallback: 30, fallback: 25, inc: 5,
          weightPrescription: { fallbackWeight: 20, workW: 15 },
          warmup: [{ weight: 5, loadFallback: 2 }],
        },
    ...
    for (const [key, value] of Object.entries({
      weight: 100, topW: 101, fallbackWeight: 50, resolvedWeight: 40, bw: 10,
      workW: 75, workWeight: 80, workResolvedWeight: 90, loadFallback: 30, fallback: 25, inc: 5,
    ...
    expect(target.weightPrescription.workW).toBeCloseTo(15 / 0.45359237, 8)
    expect(target.warmup[0].weight).toBeCloseTo(5 / 0.45359237, 8)
